...
public class S01_ScanningForm extends PageBase {
    ...
    public void fillForm() throws InterruptedException {
        ...
        Hooks.driver.findElement(By.xpath("//android.view.ViewGroup[1]/android.widget.RadioGroup/android.widget.RadioButton[2]")).click();
        Thread.sleep(1000);
        ...
        nameOnTheBoard.click();
        nameOnTheBoard.sendKeys("Test Name");
        Hooks.driver.hideKeyboard();
        Hooks.driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[5]/android.widget.TextView")).click();
        waitFor();
        Hooks.driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.LinearLayout/android.widget.CheckBox[1]")).click();
        ...
        map.click();
        Thread.sleep(3000);
        Hooks.driver.findElement(By.id("com.youxel.check_plus:id/btn")).click();
        Hooks.driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[6]/android.widget.ImageView[2]")).click();
        Hooks.driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView")).click();
        Hooks.driver.findElement(By.id("com.google.android.documentsui:id/icon_thumb")).click();
        Hooks.driver.findElement(By.id("com.youxel.check_plus:id/save_btn")).click();
    }
}
